...
const Hamburger = ({ navOpen, setNavOpen }) => {
  ...
  return (
    <button id='burger_container' aria-label='Open menu' className='cursor-pointer flex flex-col relative h-[40px] w-[40px] justify-center my-auto md:hidden' onClick={() => setNavOpen(!navOpen)}>
