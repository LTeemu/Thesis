...
const Hamburger = ({ navOpen, setNavOpen }) => {
  ...
  return (
    <button type='button' id='burger_container' aria-label='Open menu' className='cursor-pointer flex flex-col relative h-[2rem] w-[2rem] justify-center my-auto md:hidden' onClick={() => setNavOpen(!navOpen)}>
