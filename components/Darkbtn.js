...
const Darkbtn = () => {
	...
	return (
		<button id='darkbtn_container' aria-label='Change theme' className={`cursor-pointer flex flex-col relative h-[40px] w-[40px] m-auto items-center justify-center ${loadComplete ? 'visible' : 'invisible'}`}
